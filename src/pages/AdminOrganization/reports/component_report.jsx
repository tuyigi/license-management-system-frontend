...
function ComponentReport(props) {
    ...
    const getLicenses = (token,yearValue,id) => {
        ...
        licenseInstance
            .get(`${new BackendService().COMPONENT_REPORT}?year=${yearValue}&department=${id}`)
...
export default withLocalize(ComponentReport);